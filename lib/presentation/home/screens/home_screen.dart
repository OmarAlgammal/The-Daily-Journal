...
import '../components/news_screen_component/breaking_news_component.dart';
import '../components/news_screen_component/home_app_bar_component.dart';
import '../components/news_screen_component/recommendations_news_component.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            gap16,
            RecommendationsNewsComponent(news: news),
          ],
        ),
      ),
    );
